...
class ContentType<Imported, Packed, PackingHeader> {
    ...
    constructor(public readonly FirstExtension: string, public readonly Pack: (imported: { [contentName: string]: Imported }, then: (header: PackingHeader, packed: { [contentName: string]: Packed }) => void) => void) {

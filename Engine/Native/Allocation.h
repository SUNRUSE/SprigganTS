...
#define STSRealloc(type, pointer, count) STSReallocSize(sizeof(type), pointer, count, "Failed to reallocate memory on line " STS_TO_STRING(__LINE__) " of file " __FILE__)

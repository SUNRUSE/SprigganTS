new Demo("Bouncing Balls", (group) => {
    ...
    for (let i = 0; i < 10; i++) {
        ...
        ball.Move(Content.Demos.BouncingBalls.Red.WidthPixels + Math.random() * (WidthVirtualPixels - Content.Demos.BouncingBalls.Red.WidthPixels * 2), Content.Demos.BouncingBalls.Red.HeightPixels + Math.random() * (ResolutionY - Content.Demos.BouncingBalls.Red.HeightPixels * 2))
